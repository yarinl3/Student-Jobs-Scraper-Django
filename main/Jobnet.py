...
def jobnet(username):
    ...
    jobs = []
    while True:
        url = f"https://www.jobnet.co.il/Jobs?p={page}&subprofid=1346,1283,752,766,770,1194,1506,763,1350,1073,1519," \
              f"1526,1520,689,1511,696,729,733,764,892,904,1433,976,1394,979,1079,1119,1404&checkarea=2,5,9"
        # url = https://www.jobnet.co.il/Jobs?subprofid=752,1073,1079&checkarea=2,5,9
        page += 1
